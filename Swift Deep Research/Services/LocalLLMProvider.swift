...
@MainActor
class LocalLLMProvider: ObservableObject, @preconcurrency LLMProviderProtocol {
    ...
    //let modelConfiguration = ModelRegistry.gemma_2_9b_it_4bit
    private var modelPath = "huggingface/models/mlx-community/Qwen2.5-7B-Instruct-1M-4bit"
